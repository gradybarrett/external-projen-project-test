...
Name|Description
----|-----------
[Auth0TenantProject](#auth0-tenant-project-auth0tenantproject)|Auth0 tenant configuration.
...
Name|Description
----|-----------
[Auth0TenantProjectOptions](#auth0-tenant-project-auth0tenantprojectoptions)|*No description*



## class Auth0TenantProject 🔹 <a id="auth0-tenant-project-auth0tenantproject"></a>
...
```ts
new Auth0TenantProject(options: Auth0TenantProjectOptions)
```

* **options** (<code>[Auth0TenantProjectOptions](#auth0-tenant-project-auth0tenantprojectoptions)</code>)  *No description*
...
## struct Auth0TenantProjectOptions 🔹 <a id="auth0-tenant-project-auth0tenantprojectoptions"></a>
