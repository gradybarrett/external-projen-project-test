const { Auth0TenantProject } = require('auth0-tenant-project');

const project = new Auth0TenantProject({
  author: 'Grady Barrett',
  authorAddress: 'Grady.Barrett@Gmail.com',
  defaultReleaseBranch: 'main',
  devDeps: ['auth0-tenant-project@.yalc/auth0-tenant-project'],
  jsiiFqn: 'auth0-tenant-project.Auth0TenantProject',
  name: 'external-projen-project-test',
  repositoryUrl: 'https://github.com/Grady.Barrett/external-projen-project-test.git',
